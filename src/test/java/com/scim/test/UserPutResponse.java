...
public class UserPutResponse {
	...
	// ================= Constructor =================
	public UserPutResponse(List<String> schemas, String userName, boolean active, String displayName, List<Email> emails,
			String id, Meta meta) {
	...
	public static class Builder {
		...
		public UserPutResponse build() {
			return new UserPutResponse(schemas, userName, active, displayName, emails, id, meta);
		}
	}
